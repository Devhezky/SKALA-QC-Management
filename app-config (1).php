...
*
*/
define('APP_BASE_URL', 'https://skala.narapatistudio.com/');
...
*/
define('APP_ENC_KEY', '355d1277127d51b2ba50474f3a3b9d86');
 ...
 */
define('APP_DB_USERNAME', 'u2547111_pos');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '_tQwAhJJ{WiVn');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'u2547111_skalanew');
 ...
 */
define('APP_CSRF_PROTECTION', false); // TEMPORARILY DISABLED for QC Integration